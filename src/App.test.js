...
describe("<App />", () => {
  ...
  it("search string value should update on entering text", () => {
    ...
    expect(wrapper.find('input[name="search"]').prop('value')).toBe('test string')
  });
  ...
  it("api call", async ()=> {
    ...
    await expect(axios.get).toHaveBeenCalledWith("https://geektrust.s3-ap-southeast-1.amazonaws.com/adminui-problem/members.json");
